...
public:
	...
	glm::mat4 GetViewMatrix()
	{
		...
		//return ManualLookAt(Position, Position + Front, Up);
	}

	glm::mat4 ManualLookAt(glm::vec3 pos, glm::vec3 target, glm::vec3 up)
	{
		glm::vec3 camDir = glm::normalize(pos - target);
